...
-- -----------------------------------------------------
-- Table `ProjectsAndTasks`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ProjectsAndTasks` ;

CREATE TABLE IF NOT EXISTS `ProjectsAndTasks` (
  `Project name` VARCHAR(45) NULL,
  `Task ID` INT NULL,
  INDEX `ProjectsAndTasks Project name FK_idx` (`Project name` ASC) VISIBLE,
  INDEX `ProjectsAndTasks Task ID_idx` (`Task ID` ASC) VISIBLE,
  CONSTRAINT `ProjectsAndTasks Project name FK`
    FOREIGN KEY (`Project name`)
    REFERENCES `Projects` (`Project name`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `ProjectsAndTasks Task ID`
    FOREIGN KEY (`Task ID`)
    REFERENCES `Tasks` (`Task ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `Hours` (
  ...
  `Geolocations` VARCHAR(45) NULL,
  `Project name` VARCHAR(45) NULL,
  `Phase ID` INT NULL,
  `Absence` TINYINT NOT NULL DEFAULT 0,
  ...
  INDEX `Hours project name FK_idx` (`Project name` ASC) VISIBLE,
  ...
  CONSTRAINT `Hours User ID FK`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `Hours project name FK`
    FOREIGN KEY (`Project name`)
    REFERENCES `Projects` (`Project name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
