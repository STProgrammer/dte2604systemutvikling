...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 28, 2021 at 12:38 PM
...
ALTER TABLE `Groups`
  ...
  ADD CONSTRAINT `Groups Project name` FOREIGN KEY (`projectName`) REFERENCES `Projects` (`projectName`) ON DELETE SET NULL ON UPDATE CASCADE;
