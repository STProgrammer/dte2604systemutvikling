...
CREATE TABLE IF NOT EXISTS `Projects` (
  ...
  INDEX `Project leader FK_idx` (`Project leader` ASC),
...
CREATE TABLE IF NOT EXISTS `Tasks` (
  ...
  PRIMARY KEY (`TaskID`),
  INDEX `Tasks Project name FK_idx` (`Project` ASC),
  INDEX `Tasks Category name FK_idx` (`Category` ASC),
...
CREATE TABLE IF NOT EXISTS `Hours` (
  ...
  INDEX `Who worked ID_idx` (`Who worked` ASC),
...
CREATE TABLE IF NOT EXISTS `Groups` (
  ...
  INDEX `Groups Group leader_idx` (`Group leader` ASC),
...
CREATE TABLE IF NOT EXISTS `TasksAndTags` (
  `Tag` VARCHAR(45) NOT NULL,
  `TaskID` INT NOT NULL,
  INDEX `TasksAndTags Tag FK_idx` (`Tag` ASC),
  INDEX `TasksAndTags TaskID FK_idx` (`TaskID` ASC),
...
CREATE TABLE IF NOT EXISTS `Reports` (
  ...
  INDEX `Report type_idx` (`Report type` ASC),
  INDEX `Generated by FK_idx` (`Generated by` ASC),
...
CREATE TABLE IF NOT EXISTS `GroupsAndProjects` (
  `Group name` VARCHAR(45) NOT NULL,
  `Project name` VARCHAR(45) NOT NULL,
  INDEX `GroupsAndProjects Group name FK_idx` (`Group name` ASC),
  INDEX `GroupsAndProjects Project name FK_idx` (`Project name` ASC),
...
CREATE TABLE IF NOT EXISTS `UsersAndTasks` (
  ...
  INDEX `UsersAndTasks TaskID FK_idx` (`TaskID` ASC),
...
CREATE TABLE IF NOT EXISTS `UsersAndGroups` (
  ...
  INDEX `UsersAndGroups Group name FK_idx` (`Group name` ASC),
  INDEX `UsersAndGroups UserID_idx` (`UsersID` ASC),
...
CREATE TABLE IF NOT EXISTS `UsersAndProjects` (
  ...
  INDEX `UsersAndProjects Project name_idx` (`Project name` ASC),
...
CREATE TABLE IF NOT EXISTS `TaskDependencies` (
  ...
  INDEX `Second Task FK_idx` (`Second Task` ASC),
